...
\begin{figure}
    ...
    See SI Figure 2 for two other data sets in human subjects including the original work from \citet{panichello_error-correcting_2019} and new data using the present task, all infer the existence of four consensus color categories. 
