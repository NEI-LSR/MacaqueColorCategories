...
Note that the authors of the original study show that the data is best explained by a model with four attractors, even though there are only three zero-crossings (the study was replicated by others, confirming that the best fit is with a four-attractor model \citep{panichello_error-correcting_2019}). 
...
\begin{figure}
    \centering
    \begin{fullwidth}
    \includegraphics[width=\textwidth,trim={0 7cm 0 0},clip]{Outputs/Paper/Figures/flat/SI_Human_2.png}
