...
Yet monkeys have similar cones, similar color-detection thresholds (\citep{gagin_color-detection_2014,hass_chromatic_2015}), similar visual cortex extending through the ventral visual pathway \cite{lafer-sousa_color-biased_2016}) and are thought to show similar visual cognition to humans, all of which suggests that alternative explanations cannot be found in the normal operation of the visual system. This leaves differences in language and cognition. 
