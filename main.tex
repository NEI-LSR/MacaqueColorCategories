...
\begin{figure}
    \begin{fullwidth}
    \centering
    \includegraphics[width=\textwidth+4cm,trim={0 12.5cm 0 0},clip]{Output/Paper/Figures/flat/F1_ParadigmPredictions_8.jpg}
...
\begin{figure}
    \begin{fullwidth}
    \centering
    \includegraphics[width=\textwidth+4cm,trim={0 20cm 0 0},clip]{Output/Paper/Figures/flat/F2_CombinedMMResults_5.jpg}
...
\begin{figure}
    \begin{fullwidth}
    \centering
    \includegraphics[width=\textwidth,trim={0 7cm 0 0},clip]{Output/Paper/Figures/flat/F3_TCCModel_6.jpg}
...
Third, the "stimulus-space non-uniformity" version of the model has a fixed similarity function across colors (recall that the similarity function is a function of distance), but the angular distances between the colors can differ, which results in a similarity function which is distorted when it is plotted as a function of stimulus index.
...
\begin{figure}
    \begin{fullwidth}
    \centering
    \includegraphics[width=\textwidth+4cm,trim={0 19cm 0 0},clip]{Output/Paper/Figures/flat/F4_TCCResults_4.jpg}
...
\begin{figure}
    \begin{fullwidth}
    \centering
    \includegraphics[width=\textwidth+4cm,trim={0 18cm 0 0},clip]{Output/Paper/Figures/flat/F5_CastorCogBias_6.jpg}
...
\begin{figure}
    \begin{fullwidth}
    \centering
      \includegraphics[width=\textwidth+4cm,trim={0 15cm 0 0},clip]{Output/Paper/Figures/flat/F6_ColSpace_2}
...
\begin{figure}
    \begin{fullwidth}
    \centering
      \includegraphics[width=\textwidth+4cm]{Output/Paper/Figures/flat/F7_choiceProbVsSim.png}
...
\begin{figure}
    \centering
    \begin{fullwidth}
    \includegraphics[width=\textwidth+4cm]{Output/Paper/Figures/flat/SI1_psychometric.jpg}
...
\begin{figure}
    \centering
    \begin{fullwidth}
    \includegraphics[width=\textwidth+4cm,trim={0 11cm 0 0},clip]{Output/Paper/Figures/flat/SI_Human_2.jpg}
...
\begin{figure}
    \centering
    \begin{fullwidth}
    \includegraphics[width=\textwidth+4cm]{Output/Paper/Figures/flat/SI3_MMBreakOut_2.jpg}
...
\begin{figure}
    \centering
    \begin{fullwidth}
    \includegraphics[width=\textwidth+4cm]{Output/Paper/Figures/flat/SI4_MM.jpg}
...
\begin{figure}
    \centering
    \begin{fullwidth}
    \includegraphics[width=\textwidth+4cm]{Output/Paper/Figures/flat/SI5_IndTCCv.jpg}
...
\begin{figure}
    \centering
    \begin{fullwidth}
    \includegraphics[width=\textwidth+4cm]{Output/Paper/Figures/flat/SI6_choiceMatrices.png}
...
\begin{figure}
    \centering
    \begin{fullwidth}
    \includegraphics[width=\textwidth+4cm]{Output/Paper/Figures/flat/SI7_distanceMetricComparison.png}
