...
Alternatively, the  recovered categories may correspond to repellor points (positive zero-crossing) defined by the poles of the cone-opponent mechanisms (arrowheads, Figure 1e), with the exception of the L-M pole. Yet another possibility, not mutually exclusive, is that the color categories recovered in any task depend on both the utility of the color category (which varies among categories \citep{lindsey_universality_2006, elliot_color_2015, gibson_color_2017}) and the nature of the task. This latter explanation is favored by the observation that the task developed by Bae et al recovers a fewer number of consensus color categories than the typical eight consensus (basic) color categories in English. 
...
% \begin{figure}
    % \centering
    % \begin{fullwidth}
    % \includegraphics[width=\textwidth+4cm]{SI1_psychometric.tiff}
...
% \begin{figure}
    % \centering
    % \begin{fullwidth}
    % \includegraphics[width=\textwidth,trim={0 4cm 0 0},clip]{SI_Human_2.tiff}
...
% \begin{figure}
    % \centering
    % \begin{fullwidth}
    % \includegraphics[width=\textwidth+4cm]{SI_Bae_indi.tiff}
...
% \begin{figure}
    % \centering
    % \begin{fullwidth}
    % \includegraphics[width=\textwidth+4cm]{SI3_MMBreakOut_2.tiff}
...
% \begin{figure}
    % \centering
    % \begin{fullwidth}
    % \includegraphics[width=\textwidth+4cm]{SI4_MM.tiff}
...
% \begin{figure}
    % \centering
    % \begin{fullwidth}
    % \includegraphics[width=\textwidth+4cm]{SI5_IndTCCv.tiff}
...
% \begin{figure}
    % \centering
    % \begin{fullwidth}
    % \includegraphics[width=\textwidth+4cm]{SI6_choiceMatrices.tiff}
...
% \begin{figure}
    % \centering
    % \begin{fullwidth}
    % \includegraphics[width=\textwidth+4cm]{SI7_distanceMetricComparison.tiff}
...
% \begin{figure}
    % \begin{fullwidth}
    % \centering
      % \includegraphics[width=\textwidth+4cm]{F7_choiceProbVsSim.tiff}
