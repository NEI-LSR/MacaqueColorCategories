...
% saveas(gcf,fullfile([filename,'modelfit_', datestr(now,'yymmdd-HHMMSS'), '.svg']))
...
saveas(gcf,fullfile([filename,'baseline_everySecond', datestr(now,'yymmdd-HHMMSS'), '.svg']))
% saveas(gcf,fullfile([filename,'baseline_', datestr(now,'yymmdd-HHMMSS'), '.svg']))
