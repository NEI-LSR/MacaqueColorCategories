\begin{figure}
    \centering
    \includegraphics[width=\textwidth,trim={0 12cm 0 0},clip]{../Figures/flat/F1_ParadigmPredictions_6.jpg}
...
\begin{figure}
    \includegraphics[width=\textwidth,trim={0 20cm 0 0},clip]{../Figures/flat/F2_CombinedMMResults_5.jpg}
...
\begin{figure}
    \includegraphics[width=\textwidth,trim={0 6cm 0 0},clip]{../Figures/flat/F3_TCCModel_6.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth,trim={0 18cm 0 0},clip]{../Figures/flat/F4_TCCResults_3.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth,trim={0 18cm 0 0},clip]{../Figures/flat/F5_CastorCogBias_6.jpg}
...
\begin{figure}
    \centering
      \includegraphics[width=\textwidth,trim={0 15cm 0 0},clip]{../Figures/flat/F6_ColSpace_2}
