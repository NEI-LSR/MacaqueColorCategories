...
Animal CA had a small scotoma spanning \textbackslash3degrees of visual angle in a quarter of the visual field as the result of a \textbackslash3 mm diameter V1 lesion, so the cue and choices were placed in the same (intact) hemifield, taking care to avoid overlap of the position of the cue and the choices. 
