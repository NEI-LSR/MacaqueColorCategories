...
\begin{figure}
    ...
    \caption{\textbf{Comaparing distance metrics: angular distance vs Euclidian distance.}
    We inherit the practice of using angular distance as our distance metric from prior work \citep{bae_why_2015,panichello_error-correcting_2019}, but another reasonable distance metric exists: the Euclidian distance in CIELAB and CIELUV is referred to as “Delta E”. 
