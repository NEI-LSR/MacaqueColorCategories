...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.49\textwidth}
         ...
         \includesvg[pretex=\tiny, width=\textwidth]{../Figures/working/Old/justBias.svg}
         \label{fig:JustBias}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.49\textwidth}
         ...
         \includesvg[pretex=\tiny, width=\textwidth]{../Figures/working/Old/justColSpace.svg}
    ...
    \begin{subfigure}[b]{0.49\textwidth}
         ...
         \includesvg[pretex=\tiny, width=\textwidth]{../Figures/working/Old/justBias_subset.svg}
    ...
    \begin{subfigure}[b]{0.49\textwidth}
         ...
         \includesvg[pretex=\tiny, width=\textwidth]{../Figures/working/Old/justColSpace_subset.svg}
...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.3\textwidth}
         ...
         \includesvg[pretex=\tiny, width=\textwidth]{../Figures/working/5_ColSpace/behaviorally-derived-colorspace_230510.svg}
