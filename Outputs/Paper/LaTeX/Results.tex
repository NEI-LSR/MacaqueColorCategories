...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.39\textwidth}
         \centering
         \caption{}
         \includesvg[pretex=\tiny, width=\textwidth]{../Figures/working/2_AvResults/AvResults_fromModelOutput_MixMod_linear_1230728-170739.svg}
         \label{fig:CombinedLinear}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.29\textwidth}
         \centering
         \caption{}
         \includesvg[pretex=\tiny, width=\textwidth]{../Figures/working/2_AvResults/AvResults_fromModelOutput_MixMod_polar_230728-170741.svg}
