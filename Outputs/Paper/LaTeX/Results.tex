...
\begin{figure}
    \centering
        \begin{subfigure}[b]{0.29\textwidth}
         \centering
         \caption{}
         \includesvg[pretex=\tiny, width=\textwidth]{../Figures/working/1_ParadigmAnalysisPredictions/difficulty_combinedData230727-232136.svg}
    ...
    \begin{subfigure}[b]{0.39\textwidth}
         \centering
         \caption{}
         \includesvg[pretex=\tiny, width=\textwidth]{../Figures/working/2_AvResults/AvResults_fromPreProcessedData_MixMod_linear_1230720-212119.svg}
         \label{fig:CombinedLinear}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.29\textwidth}
         \centering
         \caption{}
         \includesvg[pretex=\tiny, width=\textwidth]{../Figures/working/2_AvResults/AvResults_fromPreProcessedData_MixMod_polar_230720-212121.svg}
...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
         \centering
         \caption{}
        \includesvg[pretex=\tiny, width=\textwidth]{../Figures/working/3_TCCDemo/TCCDemo_sg_Output_fromPreProcessedData_preCombined_MixMod_polar_230721-100637.svg}
         \label{fig:JustBias}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
         \centering
         \caption{}
         \includesvg[pretex=\tiny, width=\textwidth]{../Figures/working/3_TCCDemo/TCCDemo_ssnu_Input_fromModelOutput_MixMod_polar_230721-010919.svg}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
         \centering
         \caption{}
         \includesvg[pretex=\tiny, width=\textwidth]{../Figures/working/3_TCCDemo/sm_sg_230721-100639.svg}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
         \centering
         \caption{}
         \includesvg[pretex=\tiny, width=\textwidth]{../Figures/working/3_TCCDemo/sm_ssnu_230721-010914.svg}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
         \centering
         \caption{}
         \includesvg[pretex=\tiny, width=\textwidth]{../Figures/working/3_TCCDemo/sg-kernel_230721-100641.svg}
         %\label{fig:JustBias_subset}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
         \centering
         \caption{}
         \includesvg[pretex=\tiny, width=\textwidth]{../Figures/working/3_TCCDemo/SimilarityFunction_230721-010913}\llap{\raisebox{3cm}{\includesvg[pretex=\tiny, width=2.5cm]{../Figures/working/5_ColSpace/behaviorally-derived-colorspace_230630.svg}}} 
