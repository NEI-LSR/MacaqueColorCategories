...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.32\textwidth}
         \centering
         \caption{}
         \includesvg[pretex=\ttiny, width=\textwidth]{../Figures/working/2_AvResults/AvResults_fromModelOutput_MixMod_linear_1_230728-213538.svg}
         \label{fig:CombinedLinear}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.32\textwidth}
         \centering
         \caption{}
         \includesvg[pretex=\ttiny, width=\textwidth]{../Figures/working/2_AvResults/AvResults_fromModelOutput_MixMod_polar_230728-213540.svg}
