...
\begin{figure}
    \centering
        \begin{subfigure}[t]{0.36\textwidth}
         \centering
         \caption{}
         \includesvg[pretex=\ttiny, width=\textwidth]{../Figures/working/1_ParadigmAnalysisPredictions/difficulty_combinedData230728-225520.svg}
    ...
    \begin{subfigure}[t]{0.36\textwidth}
         \centering
         \caption{}
         \includesvg[pretex=\ttiny, width=\textwidth]{../Figures/working/2_AvResults/AvResults_fromModelOutput_MixMod_linear_230729-003449.svg}
         \label{fig:CombinedLinear}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.25\textwidth}
         \centering
         \caption{}
         \includesvg[pretex=\ttiny, width=\textwidth]{../Figures/working/2_AvResults/AvResults_fromModelOutput_MixMod_polar_230729-003450.svg}
...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
         \centering
         \caption{}
        \includesvg[pretex=\tiny, width=\textwidth]{../Figures/working/3_TCCDemo/TCCDemo_sg_Output_fromPreProcessedData_postCombined_MixMod_polar_230729-025759.svg}
         \label{fig:JustBias}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
         \centering
         \caption{}
         \includesvg[pretex=\tiny, width=\textwidth]{../Figures/working/3_TCCDemo/TCCDemo_ssnu_fromModelOutput_MixMod_polar_230729-025253.svg}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
         \centering
         \caption{}
         \includesvg[pretex=\tiny, width=\textwidth]{../Figures/working/3_TCCDemo/sm_sg_230729-025801.svg}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
         \centering
         \caption{}
         \includesvg[pretex=\tiny, width=\textwidth]{../Figures/working/3_TCCDemo/sm_ssnu_230729-025249.svg}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
         \centering
         \caption{}
         \includesvg[pretex=\tiny, width=\textwidth]{../Figures/working/3_TCCDemo/sg_SimilarityFunction_230729-032003.svg}
         %\label{fig:JustBias_subset}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
         \centering
         \caption{}
         \includesvg[pretex=\tiny, width=\textwidth]{../Figures/working/3_TCCDemo/ssnu_SimilarityFunction_230729-025247}\llap{\raisebox{3cm}{\includesvg[pretex=\tiny, width=2.5cm]{../Figures/working/5_ColSpace/behaviorally-derived-colorspace_230630.svg}}} 
