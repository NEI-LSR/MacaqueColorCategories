...
\begin{figure}
    \centering
        \begin{subfigure}[b]{0.29\textwidth}
         \centering
         \caption{}
         \includesvg[pretex=\ttiny, width=\textwidth]{../Figures/working/1_ParadigmAnalysisPredictions/difficulty_combinedData230727-232136.svg}
    ...
    \begin{subfigure}[b]{0.39\textwidth}
         \centering
         \caption{}
         \includesvg[pretex=\ttiny, width=\textwidth]{../Figures/working/2_AvResults/AvResults_fromModelOutput_MixMod_linear_1230728-183658.svg}
         \label{fig:CombinedLinear}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.29\textwidth}
         \centering
         \caption{}
         \includesvg[pretex=\ttiny, width=\textwidth]{../Figures/working/2_AvResults/AvResults_fromModelOutput_MixMod_polar_230728-183701.svg}
