...
To decide which of these explanations best accounts for the macaque behavioral data, we extended the Target Confusability Competition (TCC) model \citep{schurgin_psychophysical_2020} (see Methods). 
