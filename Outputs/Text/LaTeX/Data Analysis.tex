...
\begin{figure}
     ...
     \begin{subfigure}[b]{0.45\textwidth}
         \centering
         \includegraphics[width=\textwidth]{../../Figures/working/justBias_1664376407592_0.png}
         \caption{}
         \label{fig:JustBias}
     \end{subfigure}
     \hfill
     \begin{subfigure}[b]{0.45\textwidth}
         \centering
         \includegraphics[width=\textwidth]{../../Figures/working/justColSpace_sm_1664376549422_1.png}
         \caption{}
         \label{fig:JustColSpace}
     \end{subfigure}
        \caption{\textbf{Distinguishing between cognitive biases and non-uniformity of stimulus space.} In the left-hand sub-figure is an example of how cognitive bias might appear. The right-hand is an example of how non-uniformity in stimulus space might appear.}
        \label{fig:main}
\end{figure}
